    ...
    return (
        <div className="mt-10 flex flex-col space-y-4">
            <button
                ...
                disabled={product.inventario.stockUnidades === 0 || isLoading.cart}
            ...
            >
                ...
                <span>{product.inventario.stockUnidades === 0 ? 'Agotado' : (isLoading.cart ? 'Agregando...' : 'Agregar al carrito')}</span>
            </button>
